...
<div class="container" v-if="data.item.cursus.dossierProfessionnel">
    ...
    <b-modal id="annexe-modal" size="xl" title="Ajouter des annexes" centered scrollable no-close-on-esc hide-footer>
      <v-file-input v-model="newAnnexe.pieceJointe" multiple></v-file-input>
    ...
    <v-main>
      <v-list-group v-model="form.facultatifDto">
        ...
        <v-list-item class="containerDate">
          <v-text-field v-model="newFacultatif.date" label="Sélectionnez une date" readonly :error-messages="dateErrors" required
