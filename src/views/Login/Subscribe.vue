                            ...
                            <v-card-text>
                                <v-row>
                                    <v-col cols="12">
                                        <v-row>
                                            <v-col cols="12" md="4">
                                                <v-text-field v-model="formTuteur.prenom" :rules="prenomRules" label="Prénom"
                                            ...
                                            <v-col cols="12" md="4">
                                                <v-form v-model="valid">
                                                    <v-text-field v-model="formTuteur.login" :rules="emailRules" label="E-mail"
                                                        required></v-text-field>
                                                </v-form>
                                            </v-col>
                                        </v-row>
                                    ...
                                    <v-col cols="12" md="4">
                                        <v-form v-model="valid">
                                            <v-text-field v-model="formTuteur.password" :rules="passwordRules" label="Mot de passe"
                                    ...
                                    <v-col cols="12" md="4">
                                        <v-form v-model="valid">
                                            <v-menu ref="menu" v-model="menu" :close-on-content-click="false"
                                                :return-value.sync="formTuteur.dateDeNaissance" transition="scale-transition" offset-y
                                                min-width="auto">
                                                <template v-slot:activator="{ on, attrs }">
                                                    <v-text-field v-model="formTuteur.dateDeNaissance" label="Date de naissance"
                                                        prepend-inner-icon="mdi-calendar" readonly v-bind="attrs" v-on="on"
                                                        outlined clearable></v-text-field>
                                                </template>
                                                <v-date-picker v-model="formTuteur.dateDeNaissance" :active-picker.sync="activePicker"
                                                    locale="fr"
                                                    :max="(new Date(Date.now() - (new Date()).getTimezoneOffset() * 60000)).toISOString().substr(0, 10)"
                                                    min="1950-01-01" @change="$refs.menu.save(formTuteur.dateDeNaissance)">
                                                </v-date-picker>
                                            </v-menu>
                                        </v-form>
                                    </v-col>
                                    ...
                                    <v-col cols="12" md="4">
                                        <v-form v-model="valid">
                                            <v-text-field v-model="entreprise" :rules="nameRules" label="Entreprise"
                                                required></v-text-field>
                                        </v-form>
                                    </v-col>
                                    ...
                                    <v-col cols="12" md="4">
                                        <v-form v-model="valid">
                                            <v-text-field v-model="adresse" :rules="nameRules"
                                    ...
                                    <v-col cols="12" md="4">
                                        <v-form v-model="valid">
                                            <v-select v-model="etudiantId" :items="listEtudiant"
                                                :rules="[v => !!v || 'Veuillez selectionner un étudiant']" label="Etudiant"
                                                required></v-select>
                                        </v-form>
                                    </v-col>
...
export default {
    data: () => ({
        ...
        passwordRules: [
            ...
            (v) => v.length >= 6 || "Mot de passe doit avoir au moins 6 caractères",
