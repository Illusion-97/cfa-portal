        ...
        <v-card-body v-show="active === 1" name="page Info">
          <v-card-text>
            ...
            <v-card-title disabled
              >Date de naissance : {{ student.dob }}</v-card-title
            >
            <v-card-title disabled
              >Adresse : {{ student.adresse }}</v-card-title
            >
            <v-card-title disabled>Télephone : {{ student.tel }}</v-card-title>
            <v-card-title disabled
              >Télephone fixe : {{ student.tel_fix }}</v-card-title
            >
          </v-card-text>
        </v-card-body>
          ...
          >
            <thead>
              <tr>
                <th class="text-left">
                  <v-card-subtitle
                    ><strong><a>Informations</a></strong></v-card-subtitle
                  >
                </th>
                <th class="text-left">
                  <v-card-subtitle><strong>Annexes</strong></v-card-subtitle>
                </th>
                <th class="text-left">
                  <v-card-subtitle><strong>Contenue</strong></v-card-subtitle>
                </th>
                <th class="text-left">
                  <v-card-subtitle><strong>Résumé</strong></v-card-subtitle>
                </th>
                <th class="text-left">
                  <v-card-subtitle
                    ><strong>Tableau de Compétences</strong></v-card-subtitle
                  >
                </th>
              </tr>
            </thead>
            <tbody>
              <tr v-for="item in dossProj" :key="item.id">
                ...
                <td>
                  <v-card-actions
                    ><v-btn v-model="item.comp_c">Voir</v-btn></v-card-actions
                  >
                </td>
              </tr>
            </tbody>
          ...
          >
            <thead>
              <tr>
                ...
                <th class="text-left">
                  <v-card-subtitle><strong>Absences</strong></v-card-subtitle>
                </th>
              </tr>
            </thead>
            <tbody>
...
export default {
  ...
  methods: {
    dossProj() {
      dossierProjetApi.getByIdEtudiant();
    },
  },
};
</script>