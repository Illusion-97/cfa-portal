<template>
    <div id="container-fluid">
                                    ...
                                    <v-col cols="12" md="6">
                                        <div class="w-100 d-flex justify-content-center">
                                            <v-text-field v-model="formulaireTuteur.password" label="Mot de passe*" outlined
                                                type="password" :rules="required" clearable></v-text-field>
                                        </div>
                                    </v-col>
                                </v-row>
                                <v-row>
                                    <v-col cols="12" md="3">
                                        <div class="w-100 d-flex justify-content-center">
                                            <v-text-field v-model="formulaireTuteur.telephone" label="Téléphone" outlined clearable
                                                :rules="regex"></v-text-field>
                                        </div>
                                    </v-col>
                                    <v-col cols="12" md="5">
                                        <v-select :items="listAdresse" v-model="adresseId" label="Adresse"
                                            outlined></v-select>
                                    </v-col>
                                    <v-col cols="12" md="4">
                                ...
                                <v-row>
                                    <v-col cols="12" md="6">
                                        <v-select :items="listCentreFormation" v-model="formulaireTuteur.centreFormationId"
                                            label="Centre de formation*" :rules="required" outlined></v-select>
                                    </v-col>
                                    <v-col cols="12" md="6">
                                        <v-select :items="listEntreprise" v-model="entrepriseId" label="Entreprise"
                                            outlined></v-select>
                                    </v-col>
                                </v-row>
                                <div>
                                    <small v-if="!alert">*indique les champs requis</small>
                                    <small v-else style="color: rgb(255, 0, 0)">*indique les champs requis</small>
                                </div>
        ...
        <b-modal hide-footer :ref="'modal-'">
            ...
            <v-app>
                <form v-on:submit.prevent="addTuteur">
