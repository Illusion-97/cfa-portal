...
import DetailCours from "@/views/Formateur/Cours/DetailCours.vue";
...
const routes = [
  ...
  { path: "/ajouter-cours", name: "ajouter-cours", component: AjoutCours, },
  ...
  { path: "/formateur/intervention/:id", name: "intervention-detail", component: DetailCours },
