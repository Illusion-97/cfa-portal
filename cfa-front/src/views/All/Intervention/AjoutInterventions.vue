      ...
      <div class="row">
        <div class=" col-md-12 div-form">
          <form @submit="onSubmit" @reset="onReset" v-if="show">
            ...
            <b-form-group>
              <FormationList
                @click-list="onClickChildFormation"
                :formationProp="formation_input"
              />
            </b-form-group>
            <b-form-group>
              <label class="mr-2" for="promo">Promotion :</label>
              <span
                class="btn btn-outline-dark mb-2 px-5"
                data-toggle="modal"
                data-target="#modal"
              >
                Ajouter des promotions
              </span>
              <div v-for="prom in form.promotionDto" :key="prom.id">
                <input
                  type="text"
                  name="promo"
                  id="promo"
            ...
            <div
              ...
              v-if="interventionId == null"
            >
              <b-button type="reset" variant="outline-danger">Annuler</b-button>
              <b-button type="submit" variant="outline-info" class=""
                >Envoyer</b-button
              >
            </div>
...
import ModalPromotion from "@/components/ModalPromo.vue";
