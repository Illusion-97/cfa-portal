<template>
  <section>
    <div class="container-fluid">
      <router-link :to="{ name: 'etudiant_profil' }" class="h5"
        style="cursor:pointer; color:black;text-decoration:none;">
        <font-awesome-icon :icon="['fas', 'chevron-left']" class="icon" />
        Precedent
      </router-link>

      <BodyTitle title="Modifier mes informations" />
        ...
        <div class="form-group">
          <div class="row">
            ...
            <div class="form-check col-1">
              <input class="form-check-input" type="radio" name="gridRadios" id="monsieur" value="Mr" checked
        ...
        <div class="d-flex">
          <div class="form-group col-6">
            ...
            <div class="d-flex justify-content-between">
              ...
              <input type="text" name="rue" class="form-control col-4" placeholder="rue"
  ...
  export default {
    ...
    methods: {
      getUser() {
        utilisateurApi
          ...
          .then((data) => {
            ...
            this.form = data;
            this.form.adresseDto = data.adresseDto
      ...
      submit(e) {
        ...
        this.backEndDateFormat( this.form.dateDeNaissance );
        utilisateurApi
          .save(this.form)
          .then(() =>
            this.$router.push({
